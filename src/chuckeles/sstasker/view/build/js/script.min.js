...
;angular.module("sstasker").controller("dashboardCtrl",["$scope",function(s){console.log("Dashboard state loaded"),s.viewClass="dashboard full flex",console.log("Requesting the spaceship lists"),window.$java?(s.tasks=JSON.parse(window.$java.GetTasks()),s.crew=JSON.parse(window.$java.GetCrew()),s.parts=JSON.parse(window.$java.GetParts()),console.log("Got them, sizes: "+s.tasks.length+", "+s.crew.length+", "+s.parts.length)):(s.tasks=[],s.crew=[],s.parts=[],console.log("No $java object!"))}]);
