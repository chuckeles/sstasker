...
;angular.module("sstasker").controller("toolbarCtrl",["$scope",function(o){o.update=function(){window.$java?(console.log("Requesting an update"),window.$java.Update()):console.log("No $java object!")},o.exit=function(){window.$java?(console.log("Requesting an exit"),window.$java.Exit()):console.log("No $java object!")}}]).directive("toolbar",function(){return{templateUrl:"html/toolbar.html",restrict:"E",controller:"toolbarCtrl"}});
...
;angular.module("sstasker").controller("dashboardCtrl",["$scope",function(e){console.log("Dashboard state loaded"),e.viewClass="dashboard full flex",e.details=null,e.show=function(o){e.details=o?o:null},console.log("Requesting the spaceship lists"),window.$java?(e.tasks=JSON.parse(window.$java.GetTasks()),e.crew=JSON.parse(window.$java.GetCrew()),e.parts=JSON.parse(window.$java.GetParts()),console.log("Got them, sizes: "+e.tasks.length+", "+e.crew.length+", "+e.parts.length)):(console.log("No $java object!"),console.log("Add some placeholders"),e.tasks=[{title:"New task",description:"# Testing... Testing...\n\nUsing **markdown**!"}],e.crew=[{name:"Dzejky",description:"Filthy cosmonaut",oxygen:.8}],e.parts=[{name:"Generator",description:"Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description.",health:.9,reliability:.5,works:!1}])}]);
