...
;angular.module("sstasker").controller("dashboardCtrl",["$scope","$timeout",function(o,e){console.log("Dashboard state loaded"),o.viewClass="dashboard full flex",o.details=null,o.show=function(e){o.details=e?e:null},o.update=function(){window.$java?(console.log("Requesting an update"),window.$java.Update()):console.log("No $java object!"),o.details=null;var n=document.getElementById("updateToast");n.classList.add("active"),e(function(){n.classList.remove("active")},4e3),o.details={title:"Log Aktualizácií"},window.$java?(console.log("Requesting the update log"),o.details.description="",JSON.parse(window.$java.GetUpdateLog()).forEach(function(e){o.details.description+=e+"  \n"})):o.details.description="update log  \ncoooool"},o.exit=function(){window.$java?(console.log("Requesting an exit"),window.$java.Exit()):console.log("No $java object!")},o.getLists=function(){window.$java?(o.tasks=JSON.parse(window.$java.GetTasks()),o.crew=JSON.parse(window.$java.GetCrew()),o.parts=JSON.parse(window.$java.GetParts())):(console.log("No $java object!"),console.log("Adding some placeholders"),o.tasks=[{title:"New task "+Math.floor(10*Math.random()+1),description:"# Testing... Testing...\n\nUsing **markdown**!"}],o.crew=[{name:"Dzejky",description:"Filthy cosmonaut",oxygen:Math.random()}],o.parts=[{name:"Generator",description:"Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description.",health:Math.random(),reliability:Math.random(),works:Math.random()>.5}]),e(o.getLists,1e3)},o.getLists(),o.newTask=function(){window.$java?(console.log("Requesting the creation of a new task"),window.$java.NewTask()):o.tasks.push({title:"New task "+Math.floor(10*Math.random()+1),description:"Task add using the New Task button."})}}]);
