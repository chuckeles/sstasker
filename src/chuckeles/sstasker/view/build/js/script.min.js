...
;angular.module("sstasker").controller("dashboardCtrl",["$scope",function(e){console.log("Dashboard state loaded"),e.viewClass="dashboard full flex",e.details=null,e.show=function(o){e.details=o?o:null},console.log("Requesting the spaceship lists"),window.$java?(e.tasks=JSON.parse(window.$java.GetTasks()),e.crew=JSON.parse(window.$java.GetCrew()),e.parts=JSON.parse(window.$java.GetParts()),console.log("Got them, sizes: "+e.tasks.length+", "+e.crew.length+", "+e.parts.length)):(console.log("Add some placeholders"),e.tasks=[{title:"New task",description:"# Testing... Testing...\n\nUsing **markdown**!"}],e.crew=[{name:"Dzejky",description:"Filthy cosmonaut"}],e.parts=[{name:"Generator",description:"Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description. Very long description.",health:100,reliability:96,works:!1}],console.log("No $java object!"))}]);
