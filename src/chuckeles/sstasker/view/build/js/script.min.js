...
;angular.module("sstasker").controller("dashboardCtrl",["$scope",function(s){console.log("Dashboard state loaded"),s.viewClass="dashboard full flex",console.log("Requesting the spaceship lists"),window.$java?(s.taskList=JSON.parse(window.$java.GetTasks()),s.crewList=JSON.parse(window.$java.GetCrew()),s.partList=JSON.parse(window.$java.GetParts()),console.log("Got them, sizes: "+s.taskList.length+", "+s.crewList.length+", "+s.partList.length)):(s.taskList=[],s.crewList=[],s.partList=[],console.log("No $java object!"))}]);
