...
;angular.module("sstasker").controller("dashboardCtrl",["$scope",function(s){console.log("Dashboard state loaded"),s.viewClass="dashboard full flex",console.log("Requesting the spaceship lists"),window.$java?(s.partList=window.$java.GetPartList(),console.log("Parts: "+s.partList)):(s.taskList=[],s.crewList=[],s.partList=[],console.log("No $java object!"))}]);
