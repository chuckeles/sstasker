...
;angular.module("sstasker",["ngAnimate","ui.router","hc.marked"]).controller("mainCtrl",["$state",function(e){console.log("AngularJS loaded, going to the welcome state"),e.go("welcome")}]);
