...
;angular.module("sstasker").controller("dashboardCtrl",["$scope",function(o){console.log("Dashboard state loaded"),o.viewClass="dashboard full flex",console.log("Requesting the task list"),window.$java?o.taskList=window.$java.GetTaskList():console.log("No $java object!")}]);
